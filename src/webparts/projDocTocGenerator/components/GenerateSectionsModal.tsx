import { Checkbox, createTheme, FontSizes, ITheme, Modal, PrimaryButton, Stack } from '@fluentui/react'
...
const GenerateSectionsModal = ({ setTocSections }: GenerateSectionsModalProps) => {
    return (
        <>
            <Formik
                initialValues={{
                ...
                onSubmit={(values, formikHelpers): void | Promise<any> => {
                    ...
                    _presetSections = sectionsPreset.filter((sec, secId) => values.newProjectTemplateChecks[secId])
                ...
                {({ values, ...formikProps }) => <>
                    ...
                    <PrimaryButton text="Сгенерировать разделы" name="isGenerateSectionsModalOpen"
                        onClick={() => formikProps.setFieldValue('isGenerateSectionsModalOpen', true)}
                    ...
                    <Form>
                        <Modal
                            ...
                            onDismiss={() => formikProps.setFieldValue('isGenerateSectionsModalOpen', false)}
                            isBlocking={false}
                        ...
                        >
                            ...
                            <BackContinueButtonGroup onClickBack={() => formikProps.setFieldValue('isGenerateSectionsModalOpen', false)} onClickContinue={() => formikProps.handleSubmit()} />
                        </Modal>
                    </Form>
                </>}
            </Formik>
